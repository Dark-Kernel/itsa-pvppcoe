...
const About = () => {
  return (
    <>
      {/* Main Section */}
      <section className="pt-[110px] pb-[40px] bg-[url('/img/banner-bg-extended-vertical.png')] bg-top bg-cover bg-no-repeat">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center text-center mb-4 lg:mb-1">
            <h1 className="text-white lg:text-6xl text-3xl font-bold mb-5">✨About ITSA✨</h1>
            <p className="text-[#B8B8B8] lg:text-xl text-md leading-relaxed max-w-4xl mb-8 text-justify lg:text-balance">
            ...
            <p className="text-[#B8B8B8] lg:text-xl text-md leading-relaxed max-w-4xl text-justify lg:text-balance">
